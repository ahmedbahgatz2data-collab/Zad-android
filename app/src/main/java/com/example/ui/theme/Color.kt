...
// Light Emerald and Sky Palette
val LightPrimary = Color(0xFF047857)       // Deep Emerald Green
val LightOnPrimary = Color(0xFFFFFFFF)
val LightPrimaryContainer = Color(0xFFD1FAE5) // Soft Emerald container
val LightSecondary = Color(0xFF0EA5E9)     // Sky Blue
val LightTertiary = Color(0xFF4F46E5)      // Indigo Blue
val LightBackground = Color(0xFFF0FDF4)    // Pale spiritual fresh green background
...
// Gold and Alert Colors for browsers bypass / warnings
val GoldAccent = Color(0xFFF59E0B)         // Shiny alert yellow/gold
val LightGoldContainer = Color(0xFFFEF3C7) // Golden yellow background
